...
var Offcanvas = React7.forwardRef(({
  ...
  const renderBackdrop = (0, import_react4.useCallback)((backdropProps) => (0, import_jsx_runtime7.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime7.jsx)("div", {
    ...
    ...dialogProps,
    ...props,
    className: (0, import_classnames6.default)(className, bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime7.jsx)(ModalContext_default.Provider, {
    value: modalContext,
...
var NavbarOffcanvas = React8.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime8.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React9.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react6.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react6.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded
  }), [bsPrefix, expanded, onToggle]);
  return (0, import_jsx_runtime9.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime9.jsx)(SelectableContext_default.Provider, {
...
//# sourceMappingURL=chunk-3WTKO62J.js.map
